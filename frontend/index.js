...
const toggleDarkMode = () => {
	...
	const color = dark_mode ? "dark" : "light";
	document.documentElement.style.setProperty("--background-color", `var(--background-color-${ color }`);
	document.documentElement.style.setProperty("--foreground-color", `var(--foreground-color-${ color }`);
};
